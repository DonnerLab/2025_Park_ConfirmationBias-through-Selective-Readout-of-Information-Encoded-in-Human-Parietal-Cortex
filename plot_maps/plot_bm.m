...
h1 = trisurf(tinf.faces, tinf.vertices(:,1), tinf.vertices(:,2), tinf.vertices(:,3), gb, 'edgealpha', 0, 'HandleVisibility', 'off');
if isfield(cfg, 'amb')
