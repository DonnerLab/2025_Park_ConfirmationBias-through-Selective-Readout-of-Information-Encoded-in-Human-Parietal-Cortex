...
df_numerator = 2;
df_denominator = 155;
p_eta = F*df_numerator/(F*df_numerator + df_denominator); % 0.0497 (0.01-0.06: small, 0.06-0.14: medium, >0.14: large)
...
for xp = 1:length(xpts)
    ...
    sh = scatter(xpts(xp)+ri, data(:, xp), 25, coltmp(xp,:), 'filled'); hold on;
